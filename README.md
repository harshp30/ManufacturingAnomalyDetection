...
```Segmenattion Average IoU: 0.9108```


### Sample Output:

Below is an example image of the output generated by the inferece daisy-chain and the real mask.
...
2. **Model Architecture:**
   - **CustomResNet:**
     - Custom ResNet-50 model with the final fully connected layer modified to match the number of classes.
      ...
      <a>
          <img src="images/model_architecture_classification.png" alt="Segmentation Model" width="400" height="1500">
      </a>
